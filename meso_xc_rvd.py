...
def analyze_block(i0,
                  ...
                  tx_ch="ch007",
                  r0=50,r1=110, # range interval to store
                  max_dop=62.6, # largest Doppler shift (Hz) stored (62.5 Hz is the max with five beams and 1.6 ms ipp)
                  rdec=4,
                  txlen=132,
                  plot=True,
    ...
    data_out={}
    data_out["xc_arr"]=[n.array(XC[:,:,:,ri0:ri1:rdec],dtype=n.complex64)]
    data_out["fvec"]=fvec
    data_out["rvec"]=rvec[ri0:ri1:rdec]
    data_out["r0"]=[ri0]
    data_out["r1"]=[ri1]
    data_out["rdec"]=[rdec]
    data_out["f0"]=[fi0]
